    ...
    btnVerSolicitudes.addEventListener("click", async function (evento)
    {
        ...
        dataSolicOk.forEach(solicitud => {
            ...
            div.innerHTML = `<div id="divElementoVer">
                            ...
                            let btnCloseListSolic = document.getElementById(`closeList${solicitud.idSolic}`)
                            ...
                            let solicOk = dataSolicOk.find((solicitud) => solicitud.idSolic === numeroIDSolic)
                            ...
                            dataOk.forEach(jugador => {
                                ...
                                nuevoDiv.innerHTML = `<h3 class= "matchAnalysisTitle2">Match Score between ${jugador.nombreJugador} & ${solicOk.nombreSolic}: ${Math.round(puntajeMatch*100/9)}%</h3>
                                
                                <button class = "btnSubmit" type="button" id="closeMatch${solicOk.idSolic}">Close Matches</button>`
                                divMatches.appendChild(nuevoDiv)

                                divMatches.classList.add("claseDivMatches")
                                contenedorVerMatches.appendChild(divMatches)

                                let btnCloseMatchesSolic = document.getElementById(`closeMatch${solicOk.idSolic}`)
            ...
            async function verData (numeroIDjugador) {
                ...
                dataSolicOk.forEach(solicitud => {
                    ...
                    nuevoDiv.innerHTML = `<h3 class = "greenColor"> There is a match in age: ${solicitud.edadSolic} </h3>`
                        ...
                        let nuevoDiv = document.createElement("div")
                        nuevoDiv.innerHTML = ` <h4 class = "redColor"> There is NO match in age: ${solicitud.edadSolic}</h4>`
                                        divMatches.appendChild(nuevoDiv)  
                    }                    
                    ...
                    if (solicitud.posicionPrincipalSolic === jugadorOk.posicionPrincipalJugador)
                    {
                        ...
                        let nuevoDiv = document.createElement("div")
                        nuevoDiv.innerHTML = `<h4 class = "redColor">There is a NO match in Main Position: ${solicitud.posicionPrincipalSolic}</h4>`
                        divMatches.appendChild(nuevoDiv)  
                    ...
                    if (solicitud.pieHabilSolic === jugadorOk.pieHabilJugador)
                    {
                        ...
                        let nuevoDiv = document.createElement("div")
                        nuevoDiv.innerHTML = `<h4 class = "redColor">There is a NO match in Foot: ${solicitud.pieHabilSolic}</h4>`
                        divMatches.appendChild(nuevoDiv)  
                    }
                    ...
                    if (solicitud.pasaporteSolic === jugadorOk.pasaporteJugador)
                    {
                        ...
                        let nuevoDiv = document.createElement("div")
                        nuevoDiv.innerHTML = `<h4 class = "redColor">There is NO a match in Passport: ${solicitud.pasaporteSolic}</h4>`
                        divMatches.appendChild(nuevoDiv)  
                    ...
                    if (solicitud.tipoDeTransferenciaSolic === jugadorOk.tipoDeTransferenciaJugador)
                    {
                        ...
                        let nuevoDiv = document.createElement("div")
                        nuevoDiv.innerHTML = `<h4 class = "redColor">There is a NO match in Transfer Type: ${solicitud.tipoDeTransferenciaSolic}</h4>`
                        divMatches.appendChild(nuevoDiv)  
                    }
                    ...
                    if (solicitud.valorDeTransferenciaSolic === jugadorOk.valorDeTransferenciaJugador)
                    {
                        ...
                        let nuevoDiv = document.createElement("div")
                        nuevoDiv.innerHTML = `<h4 class = "redColor">There is a NO match in Transfer Value: ${solicitud.valorDeTransferenciaSolic}</h4>`
                        divMatches.appendChild(nuevoDiv)  
                    }
                    ...
                    if (solicitud.sueldoSolic === jugadorOk.sueldoJugador)
                    {
                        ...
                        let nuevoDiv = document.createElement("div")
                        nuevoDiv.innerHTML = `<h4 class = "redColor">There is a NO match in Salary: ${solicitud.sueldoSolic}</h4>`
                        divMatches.appendChild(nuevoDiv)  
                    }
                    ...
                    if (solicitud.situacionContractualSolic === jugadorOk.situacionContractualJugador)
                    {
                        ...
                        let nuevoDiv = document.createElement("div")
                        nuevoDiv.innerHTML = `<h4 class = "redColor">There is a NO match in Contract Situation: ${solicitud.situacionContractualSolic}</h4>`
                        divMatches.appendChild(nuevoDiv)  
                    }
                    ...
                    if (solicitud.claseJugadorSolic === jugadorOk.claseJugador)
                    {
                        ...
                        let nuevoDiv = document.createElement("div")
                        nuevoDiv.innerHTML = `<h4 class = "redColor">There is a NO match in Class: ${solicitud.claseJugadorSolic}</h4>`
                        divMatches.appendChild(nuevoDiv) 
                    }
                    ...
                    let nuevoDiv = document.createElement("div")
                    nuevoDiv.classList.add("claseNuevoDivMatches")
                    nuevoDiv.innerHTML = `<h3 class= "matchAnalysisTitle">Match Score between ${solicitud.nombreSolic} & ${jugadorOk.nombreJugador}: ${Math.round(puntajeMatch*100/9)}%</h3>
                    <button class = "btnSubmit" id="closeMatch${jugadorOk.id}" type="button">Close matches</button>`
                    
                    divMatches.appendChild(nuevoDiv) 
                    contenedorVerMatches.appendChild(divMatches)

                    let btnCloseMatch = document.getElementById(`closeMatch${jugadorOk.id}`)
